...
public class ChecoutForSubscriptionOfPhoneNumberUsingPayPal_TC0020 extends BaseClass
{
	@Test
	public void testChecoutForSubscriptionOfPhoneNumberUsingPayPal() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException 
	{
		...
		Thread.sleep(2000);
		pnsp.EnterCoventryCity();
		Thread.sleep(5000);
		pnsp.ClickOnCoventryCity();
		Thread.sleep(5000);
